#!/usr/bin/env node
/**
 * @yottameta/yotta-security-testing cross-platform installer.
 *
 * Usage:
 *   npx -y @yottameta/yotta-security-testing --agent <name>
 *   npx -y @yottameta/yotta-security-testing --dir <path>
 *   npx -y @yottameta/yotta-security-testing -g
 *   npx -y @yottameta/yotta-security-testing
 *   npx -y @yottameta/yotta-security-testing --list
 */
'use strict';
...
const SKILL_NAME = 'yotta-security-testing';
...
function usage() {
  console.log('yotta-security-testing installer');
  console.log('');
  console.log('Usage:');
  console.log('  npx -y @yottameta/yotta-security-testing --agent <name>  Install to an agent default directory');
  console.log('  npx -y @yottameta/yotta-security-testing --dir <path>     Install to a custom directory');
  console.log('  npx -y @yottameta/yotta-security-testing -g               Install to all known agent directories');
  console.log('  npx -y @yottameta/yotta-security-testing                  Auto-detect project-level directories');
  console.log('  npx -y @yottameta/yotta-security-testing --list           List supported agent directories');
  console.log('');
  console.log('Options:');
